    ...
    def process_all(self, dataset_path):
        for song_folder in os.listdir(dataset_path):
            ...
            try:
                ...
                #self.song_summaries.append({
                    #'song_id': song_folder,
                    #'total_notes': len(notes),
                    #'num_chord_tones': len(processor.get_chord_tones_only()),
                    #'num_non_chord_tones': len(processor.get_non_chord_tones_only()),
...
if __name__ == "__main__":
    ...
    #print(f"notes: {notes}")
    #chords = load_data('models/unique_chords.pkl')
